...
const QHash<QString, QString> &enDict()
{
    static const QHash<QString, QString> en = {
        ...
        {QStringLiteral("A SEGUIR — %1"), QStringLiteral("UP NEXT — %1")},
        {QStringLiteral("Remover da fila"), QStringLiteral("Remove from queue")},
        {QStringLiteral("Limpar"), QStringLiteral("Clear")},
        {QStringLiteral("Remover todas as músicas avulsas da fila"), QStringLiteral("Remove all manually queued tracks")},
        ...
        {QStringLiteral("Não foi possível ler a playlist do Spotify. Playlists privadas não podem ser importadas — torne a playlist pública e tente novamente."), QStringLiteral("Could not read the Spotify playlist. Private playlists can't be imported — make it public and try again.")},
        ...
        {QStringLiteral("Esta playlist do YouTube é privada e não pode ser importada. Torne-a pública ou não listada e tente novamente."), QStringLiteral("This YouTube playlist is private and can't be imported. Make it public or unlisted and try again.")},
